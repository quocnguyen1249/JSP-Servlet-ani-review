...
<c:url var ="CategogyURL" value="/admin-category"/>
			...
			function deleteAnimes(data) {
				$.ajax({
					...
					success: function (result) {
						window.location.href = "${CategogyURL}?type=list&maxPageItem=6&page=1&message=delete_success";
					},
					error: function (error) {
						window.location.href = "${CategogyURL}?type=list&maxPageItem=6&page=1&message=error_system";
					}
				});
			}
		</script>
