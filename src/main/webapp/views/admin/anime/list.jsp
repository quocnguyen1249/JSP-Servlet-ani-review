...
<c:url var ="NewURL" value="/admin-anime"/>
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<body>
		...
		<form action="<c:url value='/admin-anime'/>" id="formSubmit" method="get">
										...
										<div class="pull-right tableTools-container">
											<div class="dt-buttons btn-overlap btn-group">
												<a flag="info"
												   ...
												   title='Thêm bài viết' href='<c:url value="/admin-anime?type=edit"/>'>
															<span>
												...
												<tbody>
													<c:forEach var="item" items="${model.listResult}">
														<tr>
															...
															<td>${item.title}</td>
															<td>
																<c:url var="editURL" value="/admin-anime">
